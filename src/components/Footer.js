...
const Footer = () => {
  return (
    <div className='bg-zakvan_red-dark py-10 text-white text-xs md:text-base text-center sm:text-left'>
      <div className='max-w-screen-2xl mx-auto'>
        <div className='grid md:grid-cols-2 lg:grid-cols-3 items-center space-y-4'>
          ...
          <div>
            <h4 className='font-bold text-base sm:text-xl'>Amazon Payment</h4>
